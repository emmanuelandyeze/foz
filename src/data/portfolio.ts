...
export const caseStudies: CaseStudy[] = [
	...
	// 	results: [],
	// 	technologies: [],
	// 	link: 'https://football.foz.ng',
	// },
	{
		id: 'kamkaa',
		title: 'Kamkaa Hotel & Suites',
		client: 'Kamkaa',
		category: 'Web Development',
		image: '/kamkaa.png',
		brief:
		...
		results: [],
		technologies: [],
		link: 'https://kamkaa.com.ng/',
	},
	{
		id: 'seraph',
		title: 'Seraphs Care',
		client: 'Seraphs Care UK',
		category: 'Web Development',
		image: '/seraph.png',
		brief: 'Delivering quality care with excellence',
		challenge: 'N/A',
		solution: 'N/A',
		results: [],
		technologies: [],
		link: 'https://seraphscare.vercel.app/',
	},
	{
		id: 'serviscall',
		title: 'Serviscall',
		client: 'Serviscall',
		category: 'Web Development',
		image: '/serviscall.png',
		brief:
			'Home maintenance, electrical services, carpentry, metal works, cleaning, painting, flooring, ICT services, and project management.',
		challenge: 'N/A',
		solution: 'N/A',
		results: [],
		technologies: [],
		link: 'https://serviscall-home.vercel.app/',
	},
];
